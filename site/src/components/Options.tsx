import { CompilerPackageNames, compilerVersionCollection, constants, TreeMode } from "../shared";
    ...
    <div id={constants.css.options.id} ref={containerRef}>
      ...
      <div className="menu" hidden={!showOptionsMenu}>
        ...
        <div className="bottomLinks">
          <ExternalLink
            text="About"
            url="https://github.com/dsherret/ts-ast-viewer/tree/main/docs/about.md"
          />
          <span>&nbsp;|&nbsp;</span>
